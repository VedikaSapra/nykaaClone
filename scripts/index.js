...
logout.addEventListener("click",()=>{
    ...
    if (!token || token === "null") {
        ...
        // Logged in, show account/profile options (or logout)
        // You can expand this section as needed
        alert("You are already logged in. Click Logout in the profile menu to sign out.");
    }
})
...
async function getUsername(){
    ...
    if(token!=null){
        ...
        try {
            const url = `https://rich-gray-dolphin-hat.cyclic.app/user`
